...
public class ViewAppointmentController {
    ...
    public Result saveOrUpdate(@RequestBody ViewAppointment viewAppointment) {
        Long loginUserId = LoginUserHolder
                .getLoginUser()
                .getUserId();
        viewAppointment.setUserId(loginUserId);
    ...
    public Result<List<AppointmentItemVo>> listItem() {
        List<AppointmentItemVo> appointmentItemVoList = viewAppointmentService.listItemByUserId(
                LoginUserHolder
                        .getLoginUser()
                        .getUserId());
